...
const handleSortASC = () => {
    ...
    const data = array_mov.sort((a, b) => parseFloat(b.rating) - parseFloat(a.rating));
    console.log(array_mov.sort((a, b) => parseFloat(a.rating) - parseFloat(b.rating)))
...
const handleSortDES = () => {
    console.log("DES");
    console.log(array_mov.sort((a, b) => parseFloat(b.rating) - parseFloat(a.rating)))
}
